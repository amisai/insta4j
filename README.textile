...
1. Fork the project source code on "Github":https://github.com/dzontak/insta4j

bc. git clone git@github.com:dzontak/insta4j.git

2. Build the client with maven

bc. mvn install

3. Add insta4j-client and insta4j-simpleclient as dependencies to your pom
